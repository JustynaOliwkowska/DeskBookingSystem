...
urlpatterns = [
    ...
    path('add/area/', add_area, name="add-areas"),
    path('show/areas/', show_areas, name="all-areas"),
    path('desk/reservation/<int:id>', desk_reservation, name="desk-reservation"),
    path('reservation/details/<int:id>', desk_details, name="reservation"),
    path('reservation/details2/', reservation_details2, name="reservation"),
    path('remove/area/<int:id>', delete_area, name="delete-area"),
    path('remove/desk/<int:id>', delete_desk, name="delete-desk"),
    ...
    path('delete_notice/<int:pk>/', DeleteOfficeNote.as_view(), name="main3"),
